 ...
 */
public class BsMahArj extends BottomSheetDialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        final View view = View.inflate(getContext(),R.layout.fragment_bs_mah_arj, null);
        ...
        appBarLayout = view.findViewById(R.id.appBarwg4);
        linearLayout = view.findViewById(R.id.wg4_linear);
        ...
        view.findViewById(R.id.closeSheetwg4).setOnClickListener(new View.OnClickListener() {
            @Override
