 ...
 */
public class BsRamRaw extends BottomSheetDialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        final View view = View.inflate(getContext(),R.layout.fragment_bs_ram_raw, null);
        ...
        appBarLayout = view.findViewById(R.id.appBarwg1);
        linearLayout = view.findViewById(R.id.wg1_linear);
        ...
        view.findViewById(R.id.closeSheetwg1).setOnClickListener(new View.OnClickListener() {
            @Override
